...
const ForFounders = () => {
    return (
        <div className="bg-white dark:bg-gray-900">
            <PageMeta
                title="For Founders | Greendoor"
                description="Find your first 100 customers and build a repeatable sales process. Greendoor helps you go from 0 to 1."
                path="/for/founders"
            />
            <section className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="text-center">
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Go from 0 to 1</h1>
                    <p className="mt-4 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Find your first 100 customers and build a repeatable sales process.</p>
                </div>
                ...
                <div className="mt-16 space-y-12">
                    ...
                    <div className="grid gap-8 items-center lg:grid-cols-2">
                        ...
                        <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                            <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Build a repeatable sales process</h2>
                            <p className="mb-8 font-light lg:text-xl">Automate your outreach and track your performance. Greendoor gives you the tools you need to build a sales engine that runs on autopilot.</p>
                        </div>
                    </div>
                </div>
